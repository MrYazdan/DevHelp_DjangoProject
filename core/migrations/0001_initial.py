    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(max_length=11, unique=True, validators=[django.core.validators.RegexValidator(code='invalid IR phone number', message='Phone number must be entered in the true IR (iran) format.', regex='^(\\+98|0)?9\\d{9}$')])),
                ('ncode', models.CharField(blank=True, max_length=10, null=True, unique=True, validators=[django.core.validators.MinLengthValidator(10)])),
